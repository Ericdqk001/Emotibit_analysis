"""Generate fake parsed EmotiBit data for testing the MCI load and describe pipeline."""
...
def main():
    ...
    participants = {
        "day1": ["INTACT-MCI-01", "INTACT-MCI-02", "INTACT-MCI-03"],
        "day2": ["INTACT-MCI-01", "INTACT-MCI-02", "INTACT-MCI-04"],
    }
    ...
    for day, pids in participants.items():
        for pid in pids:
            folder = base / day / pid
