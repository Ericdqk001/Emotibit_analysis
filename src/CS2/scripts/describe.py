...
if __name__ == "__main__":
    ...
    #     if recordings:
    #         r = recordings[0]
    #         print(f"Computing stats for: {r.day}/{r.pair_id}/{r.participant}")
    ...
    #        output_file = output_dir / f"{r.pair_id}_{r.participant}_{r.day}_stats.csv"
    #         save_stats(stats_df, output_file)
    #     else:
    #         print("No recordings found")
    # else:
    #     print("Usage: python compute_stats.py <emotibit_base_path>")
    #     print("\nExample:")
    #     print(
    #        "python compute_stats.py /Volumes/INT-ACT/INTACT-CS2_restructured/emotibit"
    #     )
